...
--- @alias TypeSupportedGetV2Args
local TypeSupportedGetV2Args = {}

--- @class st.zwave.CommandClass.Alarm.TypeSupportedGetV2:st.zwave.Command
--- @alias TypeSupportedGetV2
---
--- v2 and forward-compatible v3,v4,v5,v6,v7,v8 ALARM_TYPE_SUPPORTED_GET
---
--- @field public cmd_class number 0x71
...
--- Initialize a v2 and forward-compatible v3,v4,v5,v6,v7,v8 ALARM_TYPE_SUPPORTED_GET object.
---
--- @param module st.zwave.CommandClass.Alarm command class module instance
...
--- Serialize v2 or forward-compatible v3,v4,v5,v6,v7,v8 ALARM_TYPE_SUPPORTED_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 or forward-compatible v3,v4,v5,v6,v7,v8 ALARM_TYPE_SUPPORTED_GET payload.
---
...
--- @alias TypeSupportedReportV2Args
...
--- @alias z_wave_alarm_event_access_control
...
--- @alias z_wave_alarm_event_burglar
...
--- @alias z_wave_alarm_event_clock
...
--- @alias z_wave_alarm_event_emergency
...
--- @alias z_wave_alarm_event_power_management
...
--- @alias z_wave_alarm_event_smoke
...
--- @alias z_wave_alarm_event_system
...
--- @alias z_wave_alarm_event_water
