...
--- @alias SupportedGetV2Args
local SupportedGetV2Args = {}

--- @class st.zwave.CommandClass.Meter.SupportedGetV2:st.zwave.Command
--- @alias SupportedGetV2
---
--- v2 and forward-compatible v3,v4,v5 METER_SUPPORTED_GET
---
--- @field public cmd_class number 0x32
...
--- Initialize a v2 and forward-compatible v3,v4,v5 METER_SUPPORTED_GET object.
---
--- @param module st.zwave.CommandClass.Meter command class module instance
...
--- Serialize v2 or forward-compatible v3,v4,v5 METER_SUPPORTED_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 or forward-compatible v3,v4,v5 METER_SUPPORTED_GET payload.
---
...
--- @alias GetV4
---
--- v4 and forward-compatible v5 METER_GET
---
--- @field public cmd_class number 0x32
--- @field public cmd_id number 0x01
...
--- Initialize a v4 and forward-compatible v5 METER_GET object.
---
--- @param module st.zwave.CommandClass.Meter command class module instance
...
--- Serialize v4 or forward-compatible v5 METER_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v4 or forward-compatible v5 METER_GET payload.
---
...
--- @alias ReportV4
---
--- v4 and forward-compatible v5 METER_REPORT
---
--- @field public cmd_class number 0x32
--- @field public cmd_id number 0x02
--- @field public version number 4
...
--- Initialize a v4 and forward-compatible v5 METER_REPORT object.
---
--- @param module st.zwave.CommandClass.Meter command class module instance
...
--- Serialize v4 or forward-compatible v5 METER_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v4 or forward-compatible v5 METER_REPORT payload.
---
...
---
--- v4 and forward-compatible v5 METER_SUPPORTED_REPORT
---
--- @field public cmd_class number 0x32
--- @field public cmd_id number 0x04
--- @field public version number 4
...
--- Initialize a v4 and forward-compatible v5 METER_SUPPORTED_REPORT object.
---
--- @param module st.zwave.CommandClass.Meter command class module instance
...
--- Serialize v4 or forward-compatible v5 METER_SUPPORTED_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v4 or forward-compatible v5 METER_SUPPORTED_REPORT payload.
---
...
---
--- Supported versions: 2,3,4,5; unique base versions: 2
---
--- @field public cmd_class number 0x32
--- @field public cmd_id number 0x03
--- @field public version number 2
...
---
--- Supported versions: 2,3,4,5; unique base versions: 2,3,4
---
--- @field public cmd_class number 0x32
--- @field public cmd_id number 0x04
...
--- @field public cmd_id number 0x05
--- @field public version number 2
--- @field public args st.zwave.CommandClass.Meter.ResetV2Args
local _Reset = {}
setmetatable(_Reset, {
  __call = function(cls, self, ...)
    return cls:construct(self, ...)
