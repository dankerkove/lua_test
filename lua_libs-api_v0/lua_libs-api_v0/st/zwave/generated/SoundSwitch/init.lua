...
--- Initialize a v1 SOUND_SWITCH_TONES_NUMBER_GET object.
---
...
--- Serialize v1 SOUND_SWITCH_TONES_NUMBER_GET arguments.
---
...
--- Deserialize a v1 SOUND_SWITCH_TONES_NUMBER_GET payload.
---
...
--- @alias TonesNumberReportV1
---
--- v1 SOUND_SWITCH_TONES_NUMBER_REPORT
---
--- @field public cmd_class number 0x79
...
--- Initialize a v1 SOUND_SWITCH_TONES_NUMBER_REPORT object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_TONES_NUMBER_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_TONES_NUMBER_REPORT payload.
---
...
--- Initialize a v1 SOUND_SWITCH_TONE_INFO_GET object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_TONE_INFO_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_TONE_INFO_GET payload.
---
...
--- @alias ToneInfoReportV1
---
--- v1 SOUND_SWITCH_TONE_INFO_REPORT
---
--- @field public cmd_class number 0x79
...
--- Initialize a v1 SOUND_SWITCH_TONE_INFO_REPORT object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_TONE_INFO_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_TONE_INFO_REPORT payload.
---
...
--- @alias ConfigurationSetV1
---
--- v1 SOUND_SWITCH_CONFIGURATION_SET
---
--- @field public cmd_class number 0x79
...
--- Initialize a v1 SOUND_SWITCH_CONFIGURATION_SET object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_CONFIGURATION_SET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_CONFIGURATION_SET payload.
---
...
--- Initialize a v1 SOUND_SWITCH_CONFIGURATION_GET object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_CONFIGURATION_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_CONFIGURATION_GET payload.
---
...
--- @alias ConfigurationReportV1Args
--- @field public volume integer [0,255]
...
--- @alias ConfigurationReportV1
---
--- v1 SOUND_SWITCH_CONFIGURATION_REPORT
---
--- @field public cmd_class number 0x79
...
--- Initialize a v1 SOUND_SWITCH_CONFIGURATION_REPORT object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_CONFIGURATION_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_CONFIGURATION_REPORT payload.
---
...
--- Initialize a v1 SOUND_SWITCH_TONE_PLAY_GET object.
---
--- @param module st.zwave.CommandClass.SoundSwitch command class module instance
...
--- Serialize v1 SOUND_SWITCH_TONE_PLAY_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 SOUND_SWITCH_TONE_PLAY_GET payload.
---
...
--- @field public cmd_id number 0x08
--- @field public version number 1
--- @field public args st.zwave.CommandClass.SoundSwitch.TonePlaySetV1Args
local _TonePlaySet = {}
...
--- @field public cmd_id number 0x0A
--- @field public version number 1
--- @field public args st.zwave.CommandClass.SoundSwitch.TonePlayReportV1Args
