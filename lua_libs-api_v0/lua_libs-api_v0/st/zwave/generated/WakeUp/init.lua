...
--- @field public NO_MORE_INFORMATION number 0x08 - WAKE_UP_NO_MORE_INFORMATION command id
...
WakeUp.NO_MORE_INFORMATION = 0x08
...
WakeUp._commands = {
  ...
  [WakeUp.NO_MORE_INFORMATION] = "NO_MORE_INFORMATION",
...
--- @alias IntervalSetV1
---
--- v1 and forward-compatible v2 WAKE_UP_INTERVAL_SET
---
...
--- Initialize a v1 and forward-compatible v2 WAKE_UP_INTERVAL_SET object.
---
...
--- Serialize v1 or forward-compatible v2 WAKE_UP_INTERVAL_SET arguments.
---
...
--- Deserialize a v1 or forward-compatible v2 WAKE_UP_INTERVAL_SET payload.
---
...
--- Initialize a v1 and forward-compatible v2 WAKE_UP_INTERVAL_GET object.
---
--- @param module st.zwave.CommandClass.WakeUp command class module instance
...
--- Serialize v1 or forward-compatible v2 WAKE_UP_INTERVAL_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 WAKE_UP_INTERVAL_GET payload.
---
...
--- @alias IntervalReportV1Args
--- @field public seconds integer [0,16777215]
--- @field public node_id integer [0,255]
local IntervalReportV1Args = {}

--- @class st.zwave.CommandClass.WakeUp.IntervalReportV1:st.zwave.Command
--- @alias IntervalReportV1
---
--- v1 and forward-compatible v2 WAKE_UP_INTERVAL_REPORT
---
--- @field public cmd_class number 0x84
...
--- Initialize a v1 and forward-compatible v2 WAKE_UP_INTERVAL_REPORT object.
---
--- @param module st.zwave.CommandClass.WakeUp command class module instance
...
--- Serialize v1 or forward-compatible v2 WAKE_UP_INTERVAL_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 WAKE_UP_INTERVAL_REPORT payload.
---
...
--- @alias NotificationV1Args
local NotificationV1Args = {}

--- @class st.zwave.CommandClass.WakeUp.NotificationV1:st.zwave.Command
--- @alias NotificationV1
---
--- v1 and forward-compatible v2 WAKE_UP_NOTIFICATION
---
--- @field public cmd_class number 0x84
...
--- Initialize a v1 and forward-compatible v2 WAKE_UP_NOTIFICATION object.
---
--- @param module st.zwave.CommandClass.WakeUp command class module instance
...
--- Serialize v1 or forward-compatible v2 WAKE_UP_NOTIFICATION arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 WAKE_UP_NOTIFICATION payload.
---
...
--- @class st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args
--- @alias NoMoreInformationV1Args
local NoMoreInformationV1Args = {}

--- @class st.zwave.CommandClass.WakeUp.NoMoreInformationV1:st.zwave.Command
--- @alias NoMoreInformationV1
---
--- v1 and forward-compatible v2 WAKE_UP_NO_MORE_INFORMATION
---
--- @field public cmd_class number 0x84
--- @field public cmd_id number 0x08
--- @field public version number 1
--- @field public args st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args command-specific arguments
local NoMoreInformationV1 = {}
setmetatable(NoMoreInformationV1, {
  __index = zw.Command,
  __call = function(cls, self, ...)
    local mt = {
      __index = function(tbl, key)
...
--- Initialize a v1 and forward-compatible v2 WAKE_UP_NO_MORE_INFORMATION object.
---
--- @param module st.zwave.CommandClass.WakeUp command class module instance
--- @param args st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args command-specific arguments
function NoMoreInformationV1:init(module, args, ...)
  zw.Command._parse(self, module, zw.WAKE_UP, WakeUp.NO_MORE_INFORMATION, 1, args, ...)
end

--- Serialize v1 or forward-compatible v2 WAKE_UP_NO_MORE_INFORMATION arguments.
---
--- @return string serialized payload
function NoMoreInformationV1:serialize()
  local writer = buf.Writer()
  return writer.buf
end

--- Deserialize a v1 or forward-compatible v2 WAKE_UP_NO_MORE_INFORMATION payload.
---
--- @return st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args deserialized arguments
function NoMoreInformationV1:deserialize()
  local reader = buf.Reader(self.payload)
  return reader.parsed
end
...
--- Return a deep copy of self.args, merging defaults for unset, but required parameters.
---
--- @param self st.zwave.CommandClass.WakeUp.NoMoreInformationV1
--- @return st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args
function NoMoreInformationV1._defaults(self)
  return {}
end
...
--- @param self st.zwave.CommandClass.WakeUp.NoMoreInformationV1
--- @return st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args
function NoMoreInformationV1._template(self)
  return {}
end
...
---
--- @param self st.zwave.CommandClass.WakeUp.NoMoreInformationV1
function NoMoreInformationV1._set_defaults(self)
  local defaults = self:_defaults()
  utils.merge(self.args, defaults)
end
...
--- Initialize a v2 WAKE_UP_INTERVAL_CAPABILITIES_GET object.
---
--- @param module st.zwave.CommandClass.WakeUp command class module instance
...
--- Serialize v2 WAKE_UP_INTERVAL_CAPABILITIES_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 WAKE_UP_INTERVAL_CAPABILITIES_GET payload.
---
...
--- @alias IntervalCapabilitiesReportV2Args
...
--- @alias IntervalCapabilitiesReportV2
---
...
--- @class st.zwave.CommandClass.WakeUp.NoMoreInformation
--- @alias _NoMoreInformation
---
--- Dynamically versioned WAKE_UP_NO_MORE_INFORMATION
---
--- Supported versions: 1,2; unique base versions: 1
---
--- @field public cmd_class number 0x84
--- @field public cmd_id number 0x08
--- @field public version number 1
--- @field public args st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args
local _NoMoreInformation = {}
setmetatable(_NoMoreInformation, {
  __call = function(cls, self, ...)
    return cls:construct(self, ...)
  end,
})

--- Construct a WAKE_UP_NO_MORE_INFORMATION object at the module instance serialization version.
---
--- @param module st.zwave.CommandClass.WakeUp command class module instance
--- @param args st.zwave.CommandClass.WakeUp.NoMoreInformationV1Args command-specific arguments
--- @return st.zwave.CommandClass.WakeUp.NoMoreInformation
function _NoMoreInformation:construct(module, args, ...)
  return zw.Command._construct(module, WakeUp.NO_MORE_INFORMATION, module._serialization_version, args, ...)
end

--- @class st.zwave.CommandClass.WakeUp.IntervalCapabilitiesGet
--- @alias _IntervalCapabilitiesGet
---
...
--- @alias _IntervalCapabilitiesReport
---
...
--- @field public cmd_id number 0x0A
--- @field public version number 2
--- @field public args st.zwave.CommandClass.WakeUp.IntervalCapabilitiesReportV2Args
...
WakeUp.NoMoreInformationV1 = NoMoreInformationV1
...
WakeUp.NoMoreInformation = _NoMoreInformation
...
WakeUp._lut = {
  [0] = { -- dynamically versioned constructors
    ...
    [WakeUp.NO_MORE_INFORMATION] = WakeUp.NoMoreInformation,
  ...
  [1] = { -- version 1
    ...
    [WakeUp.NO_MORE_INFORMATION] = WakeUp.NoMoreInformationV1
  },
  [2] = { -- version 2
    [WakeUp.INTERVAL_SET] = WakeUp.IntervalSetV1,
    [WakeUp.INTERVAL_GET] = WakeUp.IntervalGetV1,
