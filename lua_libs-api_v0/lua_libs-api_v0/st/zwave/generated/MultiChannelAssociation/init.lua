...
--- @alias SetV2ArgsMultiChannelNodes
...
--- @alias SetV2
---
--- v2 and forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_SET
---
...
--- Initialize a v2 and forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_SET object.
---
...
--- Serialize v2 or forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_SET arguments.
---
...
--- Deserialize a v2 or forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_SET payload.
---
...
--- @alias ReportV2ArgsMultiChannelNodes
--- @field public multi_channel_node_id integer [0,255]
--- @field public end_point integer [0,127]
--- @field public bit_address boolean
...
--- @alias ReportV2
---
--- v2 and forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REPORT
---
--- @field public cmd_class number 0x8E
...
--- Initialize a v2 and forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REPORT object.
---
--- @param module st.zwave.CommandClass.MultiChannelAssociation command class module instance
...
--- Serialize v2 or forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 or forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REPORT payload.
---
...
--- @alias RemoveV2ArgsMultiChannelNodes
--- @field public multi_channel_node_id integer [0,255]
--- @field public end_point integer [0,127]
--- @field public bit_address boolean
...
--- @alias RemoveV2
---
--- v2 and forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REMOVE
---
--- @field public cmd_class number 0x8E
...
--- Initialize a v2 and forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REMOVE object.
---
--- @param module st.zwave.CommandClass.MultiChannelAssociation command class module instance
...
--- Serialize v2 or forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REMOVE arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 or forward-compatible v3 MULTI_CHANNEL_ASSOCIATION_REMOVE payload.
---
