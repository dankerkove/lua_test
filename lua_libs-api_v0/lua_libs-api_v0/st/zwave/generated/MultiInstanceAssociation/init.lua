...
--- @alias MultiInstanceAssociation
---
...
--- @alias SetV1ArgsMultiChannelNodes
...
--- @alias GetV1
---
--- v1 and forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GET
---
--- @field public cmd_class number 0x8E
...
--- Initialize a v1 and forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GET object.
---
--- @param module st.zwave.CommandClass.MultiInstanceAssociation command class module instance
...
--- Serialize v1 or forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GET payload.
---
...
--- @alias ReportV1ArgsGroupingIdentifiers
--- @field public multi_instance_node_id integer [0,255]
--- @field public instance integer [0,255]
...
--- @alias RemoveV1ArgsGroupingIdentifiers
--- @field public multi_instance_node_id integer [0,255]
--- @field public instance integer [0,255]
...
---
--- v1 and forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_GET
---
--- @field public cmd_class number 0x8E
...
--- Initialize a v1 and forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_GET object.
---
--- @param module st.zwave.CommandClass.MultiInstanceAssociation command class module instance
...
--- Serialize v1 or forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_GET payload.
---
...
---
--- v1 and forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_REPORT
---
--- @field public cmd_class number 0x8E
...
--- Initialize a v1 and forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_REPORT object.
---
--- @param module st.zwave.CommandClass.MultiInstanceAssociation command class module instance
...
--- Serialize v1 or forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2,v3 MULTI_INSTANCE_ASSOCIATION_GROUPINGS_REPORT payload.
---
