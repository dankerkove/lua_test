...
--- @alias DeviceSpecificReportV2Args
--- @field public device_id_type integer see :lua:class:`ManufacturerSpecific.device_id_type <st.zwave.CommandClass.ManufacturerSpecific.device_id_type>`
