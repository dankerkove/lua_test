...
--- @alias SetV1
---
--- v1 and forward-compatible v2 ASSOCIATION_SET
---
...
--- Initialize a v1 and forward-compatible v2 ASSOCIATION_SET object.
---
...
--- Serialize v1 or forward-compatible v2 ASSOCIATION_SET arguments.
---
...
--- Deserialize a v1 or forward-compatible v2 ASSOCIATION_SET payload.
---
...
--- @alias GetV1
---
--- v1 and forward-compatible v2 ASSOCIATION_GET
---
--- @field public cmd_class number 0x85
...
--- Initialize a v1 and forward-compatible v2 ASSOCIATION_GET object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v1 or forward-compatible v2 ASSOCIATION_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 ASSOCIATION_GET payload.
---
...
--- @alias ReportV1
---
--- v1 and forward-compatible v2 ASSOCIATION_REPORT
---
--- @field public cmd_class number 0x85
...
--- Initialize a v1 and forward-compatible v2 ASSOCIATION_REPORT object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v1 or forward-compatible v2 ASSOCIATION_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 ASSOCIATION_REPORT payload.
---
...
--- @alias RemoveV1
---
--- v1 and forward-compatible v2 ASSOCIATION_REMOVE
---
--- @field public cmd_class number 0x85
...
--- Initialize a v1 and forward-compatible v2 ASSOCIATION_REMOVE object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v1 or forward-compatible v2 ASSOCIATION_REMOVE arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 ASSOCIATION_REMOVE payload.
---
...
--- @alias GroupingsGetV1Args
local GroupingsGetV1Args = {}

--- @class st.zwave.CommandClass.Association.GroupingsGetV1:st.zwave.Command
--- @alias GroupingsGetV1
---
--- v1 and forward-compatible v2 ASSOCIATION_GROUPINGS_GET
---
--- @field public cmd_class number 0x85
...
--- Initialize a v1 and forward-compatible v2 ASSOCIATION_GROUPINGS_GET object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v1 or forward-compatible v2 ASSOCIATION_GROUPINGS_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 ASSOCIATION_GROUPINGS_GET payload.
---
...
--- @alias GroupingsReportV1
---
--- v1 and forward-compatible v2 ASSOCIATION_GROUPINGS_REPORT
---
--- @field public cmd_class number 0x85
...
--- Initialize a v1 and forward-compatible v2 ASSOCIATION_GROUPINGS_REPORT object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v1 or forward-compatible v2 ASSOCIATION_GROUPINGS_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v1 or forward-compatible v2 ASSOCIATION_GROUPINGS_REPORT payload.
---
...
--- Initialize a v2 ASSOCIATION_SPECIFIC_GROUP_GET object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v2 ASSOCIATION_SPECIFIC_GROUP_GET arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 ASSOCIATION_SPECIFIC_GROUP_GET payload.
---
...
--- @alias SpecificGroupReportV2Args
...
--- @alias SpecificGroupReportV2
---
--- v2 ASSOCIATION_SPECIFIC_GROUP_REPORT
---
--- @field public cmd_class number 0x85
...
--- Initialize a v2 ASSOCIATION_SPECIFIC_GROUP_REPORT object.
---
--- @param module st.zwave.CommandClass.Association command class module instance
...
--- Serialize v2 ASSOCIATION_SPECIFIC_GROUP_REPORT arguments.
---
--- @return string serialized payload
...
--- Deserialize a v2 ASSOCIATION_SPECIFIC_GROUP_REPORT payload.
---
