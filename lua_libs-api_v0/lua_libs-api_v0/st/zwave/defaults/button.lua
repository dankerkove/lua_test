...
local function send_button_capability_event(device, capability_attribute, button_number)
...
local function scene_activation_handler(self, device, cmd)
  ...
  send_button_capability_event(device, capability, (scene_id + 1) // 2)
end

--- @module st.zwave.defaults.button
--- @alias button_defaults
