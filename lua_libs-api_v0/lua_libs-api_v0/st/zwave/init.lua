...
--- @param ... table 0 or more intermediate precursor tables for nested constants
...
--- @param ... number 1 or more numerical indices into the reflector ordered from top level to most deeply-nested value
