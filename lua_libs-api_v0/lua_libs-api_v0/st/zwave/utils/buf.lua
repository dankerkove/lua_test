...
--- @param ... string one or more additional strings for recursion
...
---
--- @param ... table 1 or more table-traversal paths to string, table or number arguments
...
--- @param base table base table into which to recurse
--- @param key string base table key to dereference
--- @param ... one or more additional strings for recursion
...
---
--- @param ... table 1 or more table-traversal paths to string or array-like table arguments
