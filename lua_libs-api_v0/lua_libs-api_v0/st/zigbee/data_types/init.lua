...
--- @param bytes string the bytes containing the DataType only byte_length bytes will be consumed extra will be ignored
--- @param field_name string optional name of this field (used when pretty_printing)
--- @return DataType the parsed version of DataType
...
--- @return DataType the data type class for the corresponding ID
...
--- @return DataType the parsed data type represented in the string arg
...
--- @param data_type DataType The data type class that the value should be, or be constructed into
--- @param name string the constructed data type will have its "field_name" field set to this for proper pretty printing
--- @return DataType the constructed data type of the correct value
