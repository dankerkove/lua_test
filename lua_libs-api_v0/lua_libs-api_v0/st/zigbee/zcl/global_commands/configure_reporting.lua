...
--- @class AttributeReportingConfiguration
---
...
--- @field public direction Uint8 The direction of this configuration (0x00 to tell a device to report, 0x01 to inform a device you will report)
...
--- @return AttributeReportingConfiguration the parsed config reporting record
...
--- @function AttributeReportingConfiguration:serialize
--- @return string this AttributeReportingConfiguration serialized
AttributeReportingConfiguration.serialize = utils.serialize_from_fields
...
--- @return AttributeReportingConfiguration the constructed instance
function AttributeReportingConfiguration.init(orig, data_table)
  ...
  elseif out.direction.value == config_reporting.DIRECTION_TO_CLIENT then
    ...
    error("Attribute reporting configuration must include a valid direction")
  end
...
--- @field public attr_config_records AttributeReportingConfiguration[] The list of attribute configurations
...
--- @param buf Reader the bufto parse the record from
--- @return ConfigureReporting the parsed config reporting record
...
--- @function ConfigureReporting:serialize
--- @return string this ConfigureReporting serialized
ConfigureReporting.serialize = utils.serialize_from_fields
...
--- @param orig table UNUSED this is the template class when called with class(...) syntax
--- @param attr_config_records AttributeReportingConfiguration[] The list of attribute configurations
--- @return ConfigureReporting the constructed instance
function ConfigureReporting.init(orig, attr_config_records)
  ...
  for _, v in ipairs(attr_config_records) do
    if v.direction == nil or v.attr_id == nil then
      error(orig.NAME .. " requires list of " .. config_reporting.AttributeReportingConfiguration.NAME)
    end
  end
