...
--- @return WriteAttributeResponseRecord the parsed attribute record
...
--- @function WriteAttributeResponseRecord:serialize
--- @return string this WriteAttributeResponseRecord serialized
WriteAttributeResponseRecord.serialize = utils.serialize_from_fields
...
--- @param attr_id AttributeId|number the attribute ID written to
--- @return WriteAttributeResponseRecord
...
--- @field public attr_records WriteAttributeResponseRecord[] the list of attribute records in this write response
...
--- Parse a WriteAttributeResponse from a byte string
--- @param buf Reader the buf to parse the body from
--- @return WriteAttributeResponse the parsed attribute record
...
--- @function WriteAttributeResponse:serialize
--- @return string this WriteAttributeResponse serialized
WriteAttributeResponse.serialize = utils.serialize_from_fields
...
--- @param write_attr_resp_records WriteAttributeResponseRecord[] a list of individual write attribute response records
