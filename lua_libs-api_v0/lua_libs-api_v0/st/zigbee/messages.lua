...
--- @field public src_addr Uint16 The source address of the device sending the message
--- @field public src_endpoint Uint8 The source endpoint of the device sending the message
--- @field public dest_addr Uint16 The destination address of the recipient of the message
--- @field public dest_endpoint Uint8 The destination endpoint of the recipient of the message
--- @field public profile Uint16 The profile Id of the message being sent
--- @field public cluster ClusterId The cluster Id of the message
local AddressHeader = {
  NAME = "AddressHeader",
...
--- @return AddressHeader a new instance of the address header parsed from the bytes
...
--- A function for serializing this AddressHeader
--- @return string This message frame serialized
function AddressHeader:serialize() end
AddressHeader.serialize = utils.serialize_from_fields
...
--- @param src_addr Uint16 The source address of the device sending the message
--- @param src_endpoint Uint8 The source endpoint of the device sending the message
--- @param dest_addr Uint16 The destination address of the recipient of the message
--- @param dest_endpoint Uint8 The destination endpoint of the recipient of the message
--- @param profile Uint16 The profile Id of the message being sent
--- @param cluster ClusterId The cluster Id of the message
--- @return AddressHeader The constructed AddressHeader
function AddressHeader.from_values(orig, src_addr, src_endpoint, dest_addr, dest_endpoint, profile, cluster)
  local out = {}
...
setmetatable(messages.AddressHeader, {
  __call = messages.AddressHeader.from_values
})
...
--- @class ZigbeeMessageTx
---
--- @field public NAME string "ZigbeeMessageTx" used for printing
--- @field public tx_options Uint16 Transmit options for this command
...
--- @return ZigbeeMessageTx one form of a Zigbee tx message
...
---
--- @param self ZigbeeMessageTx the message to update the addressing for
--- @param endpoint number the endpoint to address the message to
--- @return ZigbeeMessageTx self with the updated endpoint
...
---
--- @param self ZigbeeMessageTx the message to update the addressing for
--- @param device ZigbeeDevice the device this is going to
...
function ZigbeeMessageTx:serialize() end
ZigbeeMessageTx.serialize = utils.serialize_from_fields
...
function ZigbeeMessageTx.from_values(orig, data_table)
  if data_table.address_header == nil then
    error(orig.NAME .. " requires valid address header")
  end
...
setmetatable(messages.ZigbeeMessageTx, {
  __call = messages.ZigbeeMessageTx.from_values,
  __newindex = function(t, key, value) error("Zigbee Message class tables should not be modified.") end,
})

--- @class ZigbeeMessageRx
---
...
--- @return ZigbeeMessageRx one form of a Zigbee rx message
...
---
--- @param self ZigbeeMessageRx the message to update the addressing for
--- @param endpoint number the endpoint to address the message to
--- @return ZigbeeMessageRx self with the updated endpoint
...
--- @return string the bytes representing this message
function ZigbeeMessageRx:serialize() end
ZigbeeMessageRx.serialize = utils.serialize_from_fields
...
function ZigbeeMessageRx.from_values(orig, data_table)
  if data_table.address_header == nil then
    error({ code = 1, msg = orig.NAME .. " requires valid address header" })
  end
  if data_table.body == nil then
...
setmetatable(messages.ZigbeeMessageRx, {
  __call = messages.ZigbeeMessageRx.from_values,
  __newindex = function(t, key, value) error("Zigbee Message class tables should not be modified.") end,
})
