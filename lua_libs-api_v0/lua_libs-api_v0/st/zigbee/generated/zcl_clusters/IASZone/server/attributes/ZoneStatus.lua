...
--- @field public data_type IasZoneStatus the data type of this attribute
local ZoneStatus = {
  ID = 0x0002,
  NAME = "ZoneStatus",
...
--- @param data IasZoneStatus the attribute value
...
---
--- @param ... vararg the values needed to construct a IasZoneStatus
...
--- @param rep_change IasZoneStatus The amount of change of the attribute to trigger a report
