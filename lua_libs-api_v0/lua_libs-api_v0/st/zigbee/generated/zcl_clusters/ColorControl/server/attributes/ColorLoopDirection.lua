...
--- @field public data_type CcColorLoopDirectionType the data type of this attribute
...
--- @param data CcColorLoopDirectionType the attribute value
...
---
--- @param ... vararg the values needed to construct a CcColorLoopDirectionType
--- @return CcColorLoopDirectionType
...
--- @param rep_change CcColorLoopDirectionType The amount of change of the attribute to trigger a report
