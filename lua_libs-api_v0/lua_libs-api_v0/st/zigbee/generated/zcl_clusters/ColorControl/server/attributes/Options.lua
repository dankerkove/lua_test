...
--- @field public data_type CcColorOptionsType the data type of this attribute
local Options = {
  ID = 0x000F,
  NAME = "Options",
...
--- @param data CcColorOptionsType the attribute value
...
---
--- @param ... vararg the values needed to construct a CcColorOptionsType
--- @return CcColorOptionsType
...
--- @param rep_change CcColorOptionsType The amount of change of the attribute to trigger a report
...
---
--- @param device ZigbeeDevice
--- @param value CcColorOptionsType the value to write
