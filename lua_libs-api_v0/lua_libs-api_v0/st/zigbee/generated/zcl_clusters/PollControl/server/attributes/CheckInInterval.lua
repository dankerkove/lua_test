...
--- @field public data_type Uint32 the data type of this attribute
...
--- @param data Uint32 the attribute value
...
---
--- @param ... vararg the values needed to construct a Uint32
--- @return Uint32
...
--- @param rep_change Uint32 The amount of change of the attribute to trigger a report
...
---
--- @param device ZigbeeDevice
--- @param value Uint32 the value to write
