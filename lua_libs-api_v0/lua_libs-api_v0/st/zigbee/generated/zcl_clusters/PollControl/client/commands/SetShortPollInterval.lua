...
--- @field public new_short_poll_interval Uint16
...
SetShortPollInterval.serialize = utils.serialize_from_fields
...
--- @param new_short_poll_interval Uint16
...
function SetShortPollInterval.build_test_rx(device, new_short_poll_interval)
  ...
  setmetatable(out, {__index = SetShortPollInterval})
  out:set_field_names()
  return SetShortPollInterval._cluster:build_test_rx_cluster_specific_command(device, out, "client")
end
