...
--- @field public data_type LevelOptionsType the data type of this attribute
local Options = {
  ID = 0x000F,
  NAME = "Options",
...
--- @param data LevelOptionsType the attribute value
...
---
--- @param ... vararg the values needed to construct a LevelOptionsType
...
--- @param rep_change LevelOptionsType The amount of change of the attribute to trigger a report
...
---
--- @param device ZigbeeDevice
--- @param value LevelOptionsType the value to write
