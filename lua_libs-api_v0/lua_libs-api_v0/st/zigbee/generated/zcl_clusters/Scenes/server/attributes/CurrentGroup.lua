...
--- @field public data_type SGroupIdType the data type of this attribute
local CurrentGroup = {
  ID = 0x0002,
  NAME = "CurrentGroup",
...
--- @param data SGroupIdType the attribute value
...
---
--- @param ... vararg the values needed to construct a SGroupIdType
--- @return SGroupIdType
...
--- @param rep_change SGroupIdType The amount of change of the attribute to trigger a report
