...
--- @field public data_type Boolean the data type of this attribute
local DeviceEnabled = {
  ID = 0x0012,
  NAME = "DeviceEnabled",
...
--- @param data Boolean the attribute value
...
---
--- @param ... vararg the values needed to construct a Boolean
--- @return Boolean
