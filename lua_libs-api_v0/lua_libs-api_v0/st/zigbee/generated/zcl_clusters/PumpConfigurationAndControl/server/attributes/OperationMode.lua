...
--- @field public data_type PumpOperationModeType the data type of this attribute
local OperationMode = {
  ID = 0x0020,
  NAME = "OperationMode",
...
--- @param data PumpOperationModeType the attribute value
...
---
--- @param ... vararg the values needed to construct a PumpOperationModeType
--- @return PumpOperationModeType
...
--- @param rep_change PumpOperationModeType The amount of change of the attribute to trigger a report
...
---
--- @param device ZigbeeDevice
--- @param value PumpOperationModeType the value to write
