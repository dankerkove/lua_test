...
--- @field public data_type DrlkOperatingModeType the data type of this attribute
local OperatingMode = {
  ID = 0x0025,
  NAME = "OperatingMode",
...
--- @param data DrlkOperatingModeType the attribute value
...
---
--- @param ... vararg the values needed to construct a DrlkOperatingModeType
--- @return DrlkOperatingModeType
...
--- @param rep_change DrlkOperatingModeType The amount of change of the attribute to trigger a report
...
---
--- @param device ZigbeeDevice
--- @param value DrlkOperatingModeType the value to write
