...
---
--- @param device Device The device to send the read command to
--- @return ZigbeeMessageTx The constructed ReadAttribute body with the message headers to send
--- @see cluster_base
...
--- are read only.
---
--- @param device Device The device to send the write command to
--- @param value DataType The value to write to this cluster attribute
--- @return ZigbeeMessageTx The constructed WriteAttribute body with the message headers to send
...
---
--- @param device Device The device to send the configure command to
...
--- @param rep_change DataType The amount of change necessary to trigger a report (only necessary on non-discrete data types)
--- @return ZigbeeMessageTx The constructed ConfigureReporting body with the message headers to send
...
--- @param value value The value to use to create the DataType
--- @return DataType The constructed DataType of this attribute
...
--- @param cluster_id ClusterId the cluster id of the cluster the attribute is a part of
--- @param attr_id AttributeId the attribute id to read
--- @return ZigbeeMessageTx the ReadAttribute command
...
--- @param device Device the device to send the command to
--- @param cluster_id ClusterId the cluster id of the cluster the attribute is a part of
--- @param attr_id AttributeId the attribute id to write
--- @param data DataType the value to write to this attribute
--- @return ZigbeeMessageTx the WriteAttribute command
...
--- @param device Device the device to send the command to
--- @param cluster_id ClusterId the cluster id of the cluster the attribute is a part of
--- @param attr_id AttributeId the attribute id being configured
--- @param data_type ZigbeeDataType the data type of the attribute being configured
--- @param min_reporting_interval Uint16 the minimum reporting interval for this configuration
--- @param max_reporting_interval Uint16 the maximum reporting interval for this configuration
--- @param reportable_change DataType the change necessary to trigger a report, only present if data_type is not discrete
--- @return ZigbeeMessageTx the ConfigureReporting command
...
function cluster_base_index.build_cluster_attribute(cluster, attribute_id, attribute_name, base_type, writable, is_complex)
  ...
  if writable then
    ...
    attr.write = function(self, device, value)
      error("Attribute " .. self.NAME .. " is not writable.")
    end
  end
