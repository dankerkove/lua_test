...
--- @field public data_type ZigbeeDataType the data type of the attribute
...
--- @field public reportable_change ZigbeeDataType Only used for non-discrete data types, the change necessary to trigger a report
